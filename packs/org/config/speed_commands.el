...
;; The variable org-speed-commands-default sets a lot of useful defaults
;; for speed command keys. The default keys I use the most are I and O
;; for clocking in and out and t to change todo state.
